<script setup lang="ts">
  ...
  import SyllabusTab from "./SyllabusTab.vue";
  import TutorialTab from "./TutorialTab.vue";
  import EnrolledTab from './EnrolledTab.vue'
  import ProfessorTab from './ProfessorTab.vue'
